...
* Новый тип карты
    ...
    * При создании мира есть шанс 25% что это будет зимний мир. Однако на Рождество шанс на зимний мир составляет 100%.[2]
...
* Снег (блок) (до Texture Update).png Снежный блок
* Сахарный тростник JE1 BE1.pngСахарный тростник (предмет) (до Texture Update).png Тростник
    * Можно найти у воды.
    * Не может быть установлен на песок.
* Глиняный блок (до Texture Update).png Глиняные блоки
> Генерируются под водой.

#### Предметы

* Снежок (до Texture Update).png Снежок
> Может быть брошен, но не наносит урон.
* Кактус
> Игроки получают 1 (Half Heart.svg) урон при разрушении кактуса, щелкнув правой кнопкой мыши по нему или когда ходят на нём.

#### Предметы

* Ведро с молоком (до Texture Update).png Молоко
...
* Вагонетка с печью (Предмет).png Вагонетка с печью (до Beta 1.2).png Вагонетка с печью

* Вагонетка с сундуком (Предмет).png Вагонетка с сундуком (до Beta 1.8).png Вагонетка с сундуком
...
* Скелет-наездник JE1.png Скелет-наездник[2]
...
* Новые блоки
    ...
    * Железная решётка
    * Арбуз
* Полностью функциональный режим Творчество.[4][5]
...
* Натуральные структуры
    ...
    * Новая генерация биомов, делающая их более обширными и добавляющая некоторые новые элементы:
        * Реки, протекающие через/между биомами.[9]
...
* Главное меню
    ...
    * Добавлены настройки вида и яркости.[12]
